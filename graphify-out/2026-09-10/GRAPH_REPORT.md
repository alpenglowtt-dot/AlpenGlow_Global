# Graph Report - AlpenGlow work  (2026-07-28)

## Corpus Check
- 69 files · ~524,816 words
...
## Knowledge Gaps
- **46 isolated node(s):** `vps-deploy.sh script`, `Deploy workflow`, `graphify`, `Answer`, `Outcome` (+41 more)
...
- **Why does `_renderStep()` connect `Community 0` to `Community 2`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `vps-deploy.sh script`, `Deploy workflow`, `graphify` to the rest of the system?**
